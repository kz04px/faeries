#[cfg(test)]
mod tests {
    use games::{ataxx::AtaxxPosition, gamerules::GameRules, perft::perft_impl};

    #[test]
    fn perft() {
        let tests = [
            ("7/7/7/7/7/7/7 x 0 1", vec![1, 0]),
            ("7/7/7/7/7/7/7 o 0 1", vec![1, 0]),
            (
            ...
            ("x5o/7/7/7/7/7/o5x x 100 1", vec![1, 0]),
            ("x5o/7/7/7/7/7/o5x o 100 1", vec![1, 0]),
            (
                "7/7/7/7/-------/-------/x5o x 0 1",
