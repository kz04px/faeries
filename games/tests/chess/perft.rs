...
mod tests {
    ...
    fn perft_enpassant() {
        let tests = [
            ...
            ("4k3/8/8/K1PpP2r/8/8/8/8 w - d6 0 1", vec![1, 9, 139]),
            ("4k3/8/8/K2pP1rP/8/8/8/8 w - d6 0 1", vec![1, 7, 110]),
            // EP - pinned vertical
            ...
            ("4k3/8/8/3PpP2/3K4/8/8/8 w - e6 0 1", vec![1, 9, 46]),
            // EP - double check
            ("4k3/2rn4/8/2K1pP2/8/8/8/8 w - e6 0 1", vec![1, 4, 75]),
            ("4k3/8/2n5/4pP2/3K4/8/8/8 w - e6 0 1", vec![1, 7, 90]),
            // EP - block check
            ("4k3/8/K6r/3pP3/8/8/8/8 w - d6 0 1", vec![1, 6, 109]),
            ("4k3/8/K6q/3pP3/8/8/8/8 w - d6 0 1", vec![1, 6, 151]),
            ("4k3/8/r6K/3pP3/8/8/8/8 w - d6 0 1", vec![1, 6, 107]),
            ("4k3/8/q6K/3pP3/8/8/8/8 w - d6 0 1", vec![1, 6, 149]),
            ("8/8/8/8/3Pp3/R6k/8/4K3 b - d3 0 1", vec![1, 6, 107]),
            ("8/8/8/8/3Pp3/Q6k/8/4K3 b - d3 0 1", vec![1, 6, 149]),
            ("8/8/8/8/3Pp3/k6R/8/4K3 b - d3 0 1", vec![1, 6, 109]),
            ("8/8/8/8/3Pp3/k6Q/8/4K3 b - d3 0 1", vec![1, 6, 151]),
            // left/right wrap
            ("4k3/7P/7P/pP5P/7P/7P/7P/4K3 w - a6 0 1", vec![1, 11, 58]),
            ("4k3/P7/P7/P5Pp/P7/P7/P7/4K3 w - h6 0 1", vec![1, 11, 58]),
        ];
        ...
        for (fen, results) in tests {
            ...
            for (idx, result) in results.iter().enumerate() {
                let nodes = pos.perft(idx as i32);
    ...
    fn perft_extra() {
        let tests = [
            ...
            // left/right wrap
            (
                "q3k3/p6P/p6P/p6P/p6P/p6P/p6P/4K3 w - - 0 1",
                vec![1, 9, 138],
            ),
            (
                "4k2q/P6p/P6p/P6p/P6p/P6p/P6p/4K3 w - - 0 1",
                vec![1, 9, 132],
            ),
        ];
